...
<div class="module-toolbar">
  ...
  <div class="toolbar-row">
    ...
    <button class="overlay-toggle" onclick={() => showAdapterOverlays = !showAdapterOverlays} title={showAdapterOverlays ? 'Hide overlays' : 'Show overlays'}>
  ...
  <div class="toolbar-row">
    ...
    <button class="overlay-toggle" onclick={() => showModuleOverlays = !showModuleOverlays} title={showModuleOverlays ? 'Hide overlays' : 'Show overlays'}>
